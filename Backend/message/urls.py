...
urlpatterns = [
    ...
    path('change-password/', views.api_change_password, name='change_password'),
    ...
    path('api/partnership-requests/', views.api_get_partnership_requests, name='partnership_requests'),
